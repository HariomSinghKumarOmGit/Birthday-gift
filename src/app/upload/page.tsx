    ...
    <div className="space-y-12 pb-12">
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6 pt-6">
        <div className="p-6 rounded-2xl glass-card border border-white/5 flex flex-col items-start gap-3">
          ...
          <h3 className="text-sm font-bold text-white">Sobel-Enhanced Saliency</h3>
          <p className="text-xs text-slate-400 leading-relaxed">
            Photos at 200px high definition. Our Sobel edge detector identifies eyes, lips and hair while HSL saturation analysis separates vibrant subjects from dull backgrounds.
          </p>
        </div>
