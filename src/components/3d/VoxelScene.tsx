  ...
  return (
    <div className="relative w-full h-full min-h-screen overflow-hidden bg-slate-950">
      ...
      <div className="absolute top-3 left-3 right-3 sm:top-6 sm:left-6 sm:right-6 z-10 flex flex-row items-center justify-between pointer-events-none gap-2">
        <div className="bg-slate-900/85 backdrop-blur-md px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl sm:rounded-2xl border border-white/10 shadow-lg pointer-events-auto flex items-center gap-2 text-white font-medium text-xs sm:text-sm truncate max-w-[50%] sm:max-w-none">
        ...
        <div className="flex items-center gap-2 pointer-events-auto shrink-0">
          {/* Top Celebrate Button - Highly visible on mobile & desktop header */}
          <button
            onClick={handleReplaySparkles}
            className="px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl sm:rounded-2xl border border-pink-500/40 text-xs font-black bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white shadow-lg shadow-purple-500/30 transition-all flex items-center gap-1.5 min-h-[40px] active:scale-95"
            title="Celebrate with confetti & sound"
          >
            <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-300 animate-bounce" />
            <span>Celebrate 🎉</span>
          </button>
